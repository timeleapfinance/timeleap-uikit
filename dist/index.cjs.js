...
var IconModule = /*#__PURE__*/Object.freeze({
    ...
    FarmIcon: Icon$1n,
    GroupsIcon: Icon$1o,
    HamburgerIcon: Icon$1p,
    HamburgerCloseIcon: Icon$1q,
    HomeIcon: Icon$1r,
    IfoIcon: Icon$1s,
    InfoIcon: Icon$1t,
    ...
    AuditIcon: Icon$1F,
    GooseIcon: Icon$1G,
    LogoNameIcon: Icon$1H,
    LogoRoundIcon: Icon$1I,
    MenuCapsulesIcon: Icon$1J,
    MenuHomeIcon: Icon$1K,
    MenuMoreIcon: Icon$1L,
    MenuSwapIcon: Icon$1M,
    MenuTimeLeapIcon: Icon$1N,
    MenuTreasuryIcon: Icon$1O
});
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        ...
        React__default['default'].createElement(Icon$1H, { className: "desktop-icon", isDark: isDark })));
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default['default'].createElement(Icon$1q, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$1p, { width: "24px", color: "textSubtle" }))),
...
var Avatar = function (_a) {
    ...
    var icon = image ? (React__default['default'].createElement("img", { src: image, alt: "profile avatar", height: "32px", width: "32px" })) : (React__default['default'].createElement(Icon$1V, { width: "32px", height: "32px" }));
    if (isExternal) {
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { dropdownDeep: "#EEEEEE", background: "#697da6", backgroundDisabled: "#d6d6d6", backgroundAlt: "#f1e6ca", cardBorder: "#ababab", dropdown: "#f1e6ca", contrast: "#0d0f10", invertedContrast: "#FFFFFF", input: "#ffffff", inputSecondary: "#f1e6ca", tertiary: "#bd3e41", text: "#FFFFFF", textInput: "#5a5a5a", textCard: "#5a5a5a", textDisabled: "#697da6", textSubtle: "#f1e6ca", disabled: "#f1e6ca", borderColor: "", card: "", 
    // button states
