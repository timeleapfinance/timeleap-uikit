...
var Icon$B = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 50 50" }, props),
        React.createElement("circle", { cx: "25", cy: "25", r: "24.99", fill: "#f1e6ca" }),
        React.createElement("polygon", { fill: "#697da6", points: "49.6 25.32 33.67 26.83 33.65 26.83 14 29.99 14.08 31.04 31.07 31.04 49.8 26.36 49.6 25.32" }),
        React.createElement("polygon", { fill: "#c14738", points: "24.95 10.14 10.03 31.01 26.98 31.01 32.55 5.84 24.95 10.14" })));
};

var Icon$C = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 290 100" }, props),
        React.createElement("circle", { fill: "#f1e6ca", cx: "39.42", cy: "60.1", r: "39.89" }),
        React.createElement("polygon", { fill: "#697da6", fillRule: "evenodd", points: "67.75 62.74 7.97 71.54 45.96 71.54 113.64 59.56 67.75 62.74" }),
        React.createElement("polygon", { fill: "#e25457", fillRule: "evenodd", points: "45.19 11.63 4.79 71.54 46.01 71.54 58.89 0 45.19 11.63" }),
        React.createElement("path", { fill: "#f1e6ca", d: "M138.13,77.33V28.76H126V22.67h36.44v6.09H150.31V77.33Z" }),
        React.createElement("path", { fill: "#f1e6ca", d: "M169.45,77.33V22.67h12.16V77.33Z" }),
        React.createElement("path", { fill: "#f1e6ca", d: "M191.66,77.33V22.67h2.76l26,25.91,25.94-25.91h6.09V77.33H240.23V43.91L218.9,65.23,197.75,43.91V77.33Z" }),
        React.createElement("path", { fill: "#f1e6ca", d: "M259.65,77.33V22.67H290v6.09H271.78V47H284v6H271.78V71.24H290v6.09Z" }),
        React.createElement("path", { fill: "#f1e6ca", fillRule: "evenodd", d: "M79.28,62q-.09,1.89-.36,3.75l34.72-6.14Z" })));
};
...
var Icon$1h = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React.createElement("path", { d: "M3.96 10 2.56 19 8 19 8 14 12 14 12 19 15.85 19 17.63 10 3.96 10z", fill: "#e9dec2" }),
        React.createElement("path", { d: "M17.44 8 19 1.45 1 7.73 1 8 17.44 8z", fill: "#e9dec2" })));
};

var Icon$1i = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React.createElement("polygon", { points: "10.13 4.6 11.2 1.61 11.17 1.62 3.15 9.55 19 8.82 17.68 4.36 10.13 4.6", fill: "#e9dec2" }),
        React.createElement("polygon", { points: "12.55 14.13 12.58 19.07 12.94 19.01 17.14 11.14 3.05 11.65 0.67 14.18 12.55 14.13", fill: "#e9dec2" })));
};

var Icon$1j = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React.createElement("polygon", { points: "4.63 19.04 0.2 16.37 11.48 14.09 19.8 17.95 4.63 19.04", fill: "#e9dec2" }),
        React.createElement("polygon", { points: "10.77 9.7 5.07 10.03 12.14 1 15.63 13.79 10.77 9.7", fill: "#e9dec2" })));
};

var Icon$1k = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React.createElement("path", { d: "M6.43 2.5 5.8 5.32 14.63 5.18 13.91 11.33 15.88 11.07 18.09 1.4 6.43 2.5z", fill: "#e9dec2" }),
        React.createElement("path", { d: "M12.99 18.6 3.74 14.3 1.91 6.81 11.99 6.81 12.99 18.6z", fill: "#e9dec2" })));
};

var Icon$1l = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 236 236" }, props),
        React.createElement("rect", { width: "236", height: "236", fill: "none" }),
        React.createElement("circle", { className: "cls-2", cx: "33.81", cy: "118", r: "33.81", fill: "#e9dec2" }),
        React.createElement("circle", { className: "cls-2", cx: "118", cy: "118", r: "33.81", fill: "#e9dec2" }),
        React.createElement("circle", { className: "cls-2", cx: "202.19", cy: "118", r: "33.81", fill: "#e9dec2" })));
};

var Icon$1m = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React.createElement("polygon", { points: "15.68 3.88 4.32 4.81 5.26 2.94 14.73 2 15.68 3.88", fill: "#e9dec2" }),
        React.createElement("path", { d: "M15.68,5.75,4.32,6.69,1.5,18h17ZM7,13l.6-4.16,5.17-.59L14,13Z", fill: "#e9dec2" })));
};

var Icon$1n = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React.createElement("polygon", { fill: "#e9dec2", points: "3 18 6.17 18 2.55 14.38 3 18" }),
        React.createElement("polygon", { fill: "#e9dec2", points: "17 18 17.42 14.67 14.09 18 17 18" }),
        React.createElement("polygon", { fill: "#e9dec2", points: "11.43 2 10 12 8.57 2 1 2 1.88 9.05 10.13 17.3 18.08 9.35 19 2 11.43 2" })));
};

var Icon$1o = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React.createElement("polygon", { fill: "#e9dec2", points: "12.23 15 11.61 17 3.75 13.21 13.75 9.43 13.13 11 17.15 11 15.46 2.53 2.51 1.54 2.27 5 6.71 5 7.32 3 15.18 6.79 5.18 10.57 5.8 9 2.07 9 1.54 16.47 18.46 18.46 17.77 15 12.23 15" })));
};

var Icon$1p = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React.createElement("polygon", { fill: "#e9dec2", points: "10.83 13.21 4.71 10.5 9.17 6.79 15.29 9.5 10.83 13.21" }),
        React.createElement("polygon", { fill: "#e9dec2", points: "14.54 10.12 5.37 6.06 6.86 4.82 16.03 8.88 14.54 10.12" }),
        React.createElement("polygon", { fill: "#e9dec2", points: "17.51 7.64 5.29 2.24 6.77 1 19 6.41 17.51 7.64" }),
        React.createElement("polygon", { fill: "#e9dec2", points: "5.46 9.88 14.63 13.94 13.14 15.18 3.97 11.12 5.46 9.88" }),
        React.createElement("polygon", { fill: "#e9dec2", points: "2.49 12.36 14.71 17.76 13.23 19 1 13.59 2.49 12.36" })));
};

var Icon$1q = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React.createElement("polygon", { fill: "#e9dec2", points: "13.05 11.84 9.33 14.07 5.99 12.17 2.94 14 11.43 18.83 18.21 14.78 13.05 11.84" }),
        React.createElement("polygon", { fill: "#e9dec2", points: "8.9 6.14 6.44 7.61 5.46 7.05 2.95 8.55 9.18 12.09 14.15 9.12 8.9 6.14" }),
        React.createElement("polygon", { fill: "#e9dec2", points: "10 3.77 6.36 5.95 1.79 3.35 5.43 1.17 10 3.77" })));
};
...
var CloseHandler = styled.div(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  border-radius: 0 16px 16px 0;\n  right: 8px;\n  position: absolute;\n  top: 8px;\n"], ["\n  border-radius: 0 16px 16px 0;\n  right: 8px;\n  position: absolute;\n  top: 8px;\n"])));
var StyledAlert = styled(Flex)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  position: relative;\n  background-color: ", ";\n  border-radius: 0px;\n  box-shadow: 0px 20px 36px -8px rgba(14, 14, 44, 0.1), 0px 1px 1px rgba(0, 0, 0, 0.05);\n  color: ", ";\n"], ["\n  position: relative;\n  background-color: ", ";\n  border-radius: 0px;\n  box-shadow: 0px 20px 36px -8px rgba(14, 14, 44, 0.1), 0px 1px 1px rgba(0, 0, 0, 0.05);\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
...
var Alert = function (_a) {
    ...
    return (React.createElement(StyledAlert, null,
        ...
        React.createElement(Details, { hasHandler: !!onClick },
            React.createElement(Text, { bold: true, color: "textCard" }, title),
            typeof children === "string" ? (React.createElement(Text, { color: "textCard", as: "p" }, children)) : (children)),
        onClick && (React.createElement(CloseHandler, null,
            React.createElement(StyledIconButton, { size: "sm", variant: "text", onClick: onClick },
                React.createElement(Icon$q, { width: "24px", color: "primaryDark" }))))));
};
...
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return (React.createElement(InactiveButton, __assign({ forwardedAs: as, size: size, variant: "subtle", colorKey: variant === variants.PRIMARY ? "primary" : "primary" }, props)));
    }
...
var FloatingLogoName = styled(LogoNameIcon)(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  animation: ", " 2s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 2s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var Spinner = function (_a) {
    var _b = _a.size, size = _b === void 0 ? 128 : _b;
    return (React.createElement(Container$1, null,
        React.createElement(FloatingLogoName, { width: size * 2 + "px" })));
};
...
var StyledIconButton$1 = styled(IconButton)(templateObject_2$9 || (templateObject_2$9 = __makeTemplateObject(["\n  border: 0px;\n"], ["\n  border: 0px;\n"])));
    ...
    return (React.createElement(StyledModal, null,
        React.createElement(ModalHeader, null,
            React.createElement(ModalTitle, null,
                onBack && (React.createElement(StyledIconButton$1, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React.createElement(Icon$5, { color: "primaryDark" }))),
                React.createElement(Heading, { color: "primaryDark" }, title)),
            !hideCloseButton && (React.createElement(StyledIconButton$1, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
                React.createElement(Icon$q, { color: "primaryDark" })))),
...
var Logo = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        ...
        React.createElement(Icon$1L, { className: "desktop-icon", isDark: isDark })));
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$1u, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$1t, { width: "24px", color: "textSubtle" }))),
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        ...
        React.createElement(AccordionContent, { isOpen: isOpen, isPushed: isPushed, maxHeight: React.Children.count(children) * MENU_ENTRY_HEIGHT * 2 }, children)));
};
    ...
    if (!isPushed) {
        return (React.createElement(Container$4, null,
            React.createElement(IconButton, { variant: "text", onClick: function () { return pushNav(true); } },
                React.createElement(Icon$r, { color: "textSubtle" }))));
    }
    return (React.createElement(Container$4, null,
        React.createElement(SocialEntry, null,
            ...
            React.createElement(Flex, null, socials.map(function (social, index) {
                ...
                if (social.items) {
                    return (React.createElement(Dropdown, { key: social.label, position: "top", target: React.createElement(Icon, __assign({}, iconProps, { mr: mr })) }, social.items.map(function (item) { return (React.createElement(Link, { external: true, key: item.label, href: item.href, "aria-label": item.label, color: "primaryDark" }, item.label)); })));
                }
        ...
        React.createElement(SettingsEntry, null,
            ...
            React.createElement(Dropdown, { position: "top-right", target: React.createElement(Button, { variant: "text", startIcon: React.createElement(LanguageIcon, { color: "textSubtle", width: "24px" }) },
                ...
                React.createElement(Text, { color: "primaryDark" }, lang.language))); })))));
};
...
var WalletCard = function (_a) {
    ...
    return (React.createElement(Button, { fullWidth: true, variant: "tertiary", onClick: function () {
        ...
        React.createElement(Text, { bold: true, color: "primaryBright", mr: "16px" }, title),
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React.createElement(HelpLink, { href: "https://docs.matic.network/docs/develop/wallets/getting-started/", external: true },
            React.createElement(Icon$v, { color: "primaryDark", mr: "6px" }),
...
var CopyToClipboard = function (_a) {
    ...
    return (React.createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React.createElement(Icon$t, { width: "20px", color: "primaryDark", ml: "4px" }),
...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        React.createElement(Text, { color: "primaryDark", fontSize: "20px", bold: true, style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginBottom: "8px" } }, account),
        React.createElement(Flex, { mb: "32px" },
            React.createElement(LinkExternal, { color: "primaryDark", small: true, href: "https://polygonscan.com/address/" + account, mr: "16px" }, "View on PolygonScan"),
...
export { Icon$4 as AddIcon, Alert, Icon$5 as ArrowBackIcon, Icon$6 as ArrowDownIcon, Icon$7 as ArrowDropDownIcon, Icon$8 as ArrowDropUpIcon, Icon$9 as ArrowForwardIcon, Icon$a as ArrowUpIcon, Icon$b as AutoRenewIcon, BackgroundImage, GridLayout as BaseLayout, Icon$c as BinanceIcon, Icon$2 as BlockIcon, Icon$d as BnbUsdtPairTokenIcon, Breadcrumbs, Icon$e as BunnyCardsIcon, Icon$f as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$i as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$h as CardViewIcon, Icon$g as Cards, GridLayout$1 as CardsLayout, Icon$k as ChartIcon, Checkbox, Icon as CheckmarkCircleIcon, Icon$l as CheckmarkIcon, Icon$m as ChevronDownIcon, Icon$n as ChevronLeftIcon, Icon$o as ChevronRightIcon, Icon$p as ChevronUpIcon, Icon$j as CircleOutlineIcon, Icon$q as CloseIcon, Icon$r as CogIcon, Icon$s as CommunityIcon, Icon$t as CopyIcon, CopyToClipboard, Icon$u as CrownIcon, Dropdown, Icon$1 as ErrorIcon, Flex, Heading, Icon$v as HelpIcon, Icon$w as HistoryIcon, IconButton, Image, Icon$3 as InfoIcon, Input, Icon$x as LanguageIcon, Icon$y as LaurelLeftIcon, Icon$z as LaurelRightIcon, Link, LinkExternal, Icon$A as ListViewIcon, Icon$B as LogoIcon, Icon$C as LogoNameIcon, Icon$D as LogoRoundIcon, Icon$E as MedalBronzeIcon, Icon$F as MedalGoldIcon, Icon$G as MedalPurpleIcon, Icon$H as MedalSilverIcon, Icon$I as MedalTealIcon, Menu, Icon$1k as MenuCapsulesIcon, Icon$1q as MenuDimensionsIcon, Icon$1h as MenuHomeIcon, Icon$1l as MenuMoreIcon, Icon$1o as MenuSwap2Icon, Icon$1i as MenuSwapIcon, Icon$1j as MenuTimeLeapIcon, Icon$1m as MenuTreasuryIcon, Icon$1n as MenuVaultIcon, Icon$1p as MenuWormholeIcon, Icon$J as MetamaskIcon, Icon$K as MinusIcon, Modal, ModalProvider, Icon$L as NoProfileAvatarIcon, Icon$M as OpenNewIcon, Icon$O as PancakeRoundIcon, Icon$N as PancakesIcon, Icon$Q as PlayCircleOutlineIcon, Icon$P as PocketWatchIcon, Icon$X as PresentCheckIcon, Icon$Z as PresentNoneIcon, Icon$Y as PresentWonIcon, Icon$R as PrizeIcon, Progress, Icon$V as ProgressBunny, Icon$S as ProposalIcon, Radio, Icon$1g as RefreshIcon, Icon$T as RemoveIcon, ResetCSS, Icon$15 as SearchIcon, Skeleton, Spinner, Icon$16 as StarFillIcon, Icon$17 as StarLineIcon, Svg, Icon$18 as SwapVertIcon, Icon$19 as SyncAltIcon, Tag, Icon$_ as TeamPlayerIcon, Icon$$ as TestnetIcon, Text, Icon$10 as Ticket, Icon$11 as TicketRound, Icon$12 as TimerIcon, ToastContainer, Toggle, Icon$13 as TrophyGoldIcon, Icon$14 as TuneIcon, Icon$U as VerifiedIcon, Icon$1a as VisibilityOff, Icon$1b as VisibilityOn, Icon$1c as VolumeOffIcon, Icon$1d as VolumeUpIcon, Icon$1e as VoteIcon, Icon$W as WaitIcon, Icon$1f as WarningIcon, variants$1 as alertVariants, byTextAscending, byTextDescending, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
